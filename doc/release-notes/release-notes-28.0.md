...
testnetq/BIP94 support
-----

Support for testnetq as specified in [BIP94](https://github.com/bitcoin/bips/blob/master/bip-0094.mediawiki)
has been added. The network can be selected with the `-testnetq` option and
the section header is also named `[testnetq]`.
