...
class ConfArgsTest(BitcoinTestFramework):
    ...
    def test_acceptstalefeeestimates_arg_support(self):
        ...
        for chain, chain_name in {("main", ""), ("test", "testnet3"), ("signet", "signet"), ("testnetq", "testnetq")}:
    ...
    def test_testnet3_deprecation_msg(self):
        ...
        t3_warning_log = "Warning: Support for testnet3 is deprecated and will be removed in an upcoming release. Consider switching to testnetq."
        ...
        self.log.debug("testnetq node will not log the deprecation warning")
        self.nodes[0].chain = 'testnetq'
        self.nodes[0].replace_in_config([('testnet=', 'testnetq='), ('[test]', '[testnetq]')])
        ...
        self.nodes[0].replace_in_config([('testnetq=', 'regtest='), ('[testnetq]', '[regtest]')])
